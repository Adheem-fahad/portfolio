...
export default class Cursor {
    constructor(root, target1, target2) {
        this.cursor(root, target1[0], target1[1], target2[0], target2[1])
    }
    async sameFn(target) {
    ...
    async cursor(root, target1, targetPa, target2, targetPa2) {
        ...
        css(this.cursorEl, {
            left: `${target2.offsetLeft + targetPa2.offsetLeft + this.cursorEl.clientWidth}px`,
